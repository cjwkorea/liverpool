     ...
     <Top/>
      ...
      <Carousel fade>
        <Carousel.Item>
          ...
          <Carousel.Caption>
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 첫번 째 UEFA 컵 🏆 1976-1977 </strong></h1>
        ...
        <Carousel.Item>
          ...
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 두번 째 UEFA 컵 🏆 1977-1978 </strong></h1>
            <h2 style={{color:"#000000"}}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 세번 째 UEFA 컵 🏆 1980-1981 </strong></h1>
            <h2 style={{color:"#000000"}}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 네번 째 UEFA 컵 🏆 1983-1984 </strong></h1>
            <h2 style={{color:"#000000"}}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 다섯번 째 UEFA 컵 🏆 2004-2005 </strong></h1>
            <h2 style={{color:"#000000"}}>
        ...
        <Carousel.Item>
          ...
          <Carousel.Caption>
          <Card>
      <Card.Body><h1 style={{color:"#000000"}}><strong> 여섯번 째 UEFA 컵 🏆 20018-2019 </strong></h1>
            <h2 style={{color:"#000000"}}>
